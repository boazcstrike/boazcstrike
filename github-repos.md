...
| [superfile](https://github.com/yorukot/superfile) | Pretty fancy modern terminal file manager. |
| [harper](https://github.com/Automattic/harper) | Offline, privacy-first grammar checker. Fast, open-source, Rust-powered. |
| [wmux](https://github.com/amirlehmam/wmux) | The original Windows terminal multiplexer for AI agents. Port of cmux. |
| [fnm](https://github.com/Schniz/fnm) | 🚀 Fast and simple Node.js version manager, built in Rust. |
| [dbmate](https://github.com/amacneil/dbmate) | 🚀 A lightweight, framework-agnostic database migration tool. |
| [terraform](https://github.com/hashicorp/terraform) | Safely and predictably create, change, and improve infrastructure via declarative configuration files. |
| [terraform-wrapper](https://github.com/joshrotenberg/terraform-wrapper) | A type-safe Terraform CLI wrapper for Rust. |
| [ego-lite](https://github.com/citrolabs/ego-lite) | Best browser where both you and AI agents work in parallel. |
...
| [flutter_spinners](https://github.com/selastingeorge/flutter_spinners) | 🪄 A curated library of smooth loading animations for Flutter. |
